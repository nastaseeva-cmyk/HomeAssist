...
* **`Mobile`**
  Models: MLKit FaceDetection + efficientdet.tflite (person detection) / Silero VAD for voice detection using microphone
...
* **`Thinking`**
  Port: 7000
  Model: unsloth/gemma-4-E4B-it-GGUF/gemma-4-E4B-it-Q3_K_S.gguf (quantized Google Gemma 4)
