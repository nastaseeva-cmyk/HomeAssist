...
from prompts import get_image_prompt, get_inactive_posture_prompt, get_stt_prompt, get_routine_analysis_prompt, get_inactive_posture_tts_prompt
...
def process_inactive_posture_tts(llm, location=None):
    prompt = get_inactive_posture_tts_prompt(location)
    ...
    log.info(f"Inactive Posture TTS Inference raw: {response_str}") 
    ...
    try:
        ...
        log.error(f"Error parsing Inactive Posture TTS JSON response")
        inference_json = {}
